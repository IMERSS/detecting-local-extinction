...
Polygons representing habitat for target species are then represented as grid cells. 
...
superimposed with a gridded representation of the same habitat (30x30 m^2 cells).
