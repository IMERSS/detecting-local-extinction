...
Some of the gridded cells at the fringe of the range have only a small overlap with valid habitat and so should not have their search effort referred to the full cell size of 30x30m^2. Scaling the search effort per gridded cell to take account
